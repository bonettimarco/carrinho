...
ActiveRecord::Schema.define(version: 2021_04_19_104232) do
  ...
  create_table "pedidos_produtos", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
